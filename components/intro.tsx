...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className='font-bold'>Hello, I'm Pravine.</span> I'm a{' '}
        <span className='font-bold'>full-stack developer</span> studying{' '}
        <span className='font-bold'>Computer Engineering</span>. I enjoy
      ...
      >
        ...
        <a
          ...
          href='https://www.linkedin.com/in/pravinemani/'
          target='_blank'
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href='https://github.com/pravinemani5545'
          target='_blank'
        >
          <FaGithubSquare />
        </a>
